...
struct TOutputRecursionTracker {
  ...
  TOutputRecursionTracker& operator=(const TOutputRecursionTracker &tmp) = delete; TOutputRecursionTracker& operator=(TOutputRecursionTracker&& tmp) = delete;
};
...
struct TInputRecursionTracker {
  ...
  TInputRecursionTracker& operator=(const TInputRecursionTracker &tmp) = delete; TInputRecursionTracker& operator=(TInputRecursionTracker&& tmp) = delete;
};
