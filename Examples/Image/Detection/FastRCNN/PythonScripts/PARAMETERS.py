...
#cntkBinariesDir = "." #rootDir + "resources/Release_2016_08_04/"
cntkBinariesDir = rootDir + "resources/Release_2016_08_04/"
...
############################
if datasetName.startswith("liebherr") or datasetName.startswith("toy"):
